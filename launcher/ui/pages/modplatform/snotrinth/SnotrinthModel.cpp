...
ModpackListModel::ModpackListModel(SnotrinthPage* parent) : QAbstractListModel(parent), m_parent(parent) {}
...
void ModpackListModel::performPaginatedSearch()
{
    ...
    auto netJob = makeShared<NetJob>("Snotrinth::SearchModpack", APPLICATION->network());
